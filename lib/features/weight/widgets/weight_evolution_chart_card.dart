...
void _showWeightChartInfoSheet(BuildContext context) {
...
enum _WeightPercentileStatusKind { at, above, below }

({String babyName, String percentileLabel, _WeightPercentileStatusKind kind})?
_weightPercentileStatusParts({
  ...
  final kind = estimate.isBelowTable
      ? _WeightPercentileStatusKind.below
      : estimate.isAboveTable
      ? _WeightPercentileStatusKind.above
      : _WeightPercentileStatusKind.at;
...
class _WeightPercentileStatusLine extends StatelessWidget {
  final String babyName;
  final String percentileLabel;
  final _WeightPercentileStatusKind kind;

  const _WeightPercentileStatusLine({
...
/// Tarjeta de evolución de peso con línea real del bebé y percentil OMS.
///
/// Vive fuera de la pestaña Peso para que Inicio pueda mostrar la lectura de
/// crecimiento sin duplicar la lógica de ejes, tooltip y preferencias.
class WeightEvolutionChartCard extends ConsumerWidget {
  ...
  const WeightEvolutionChartCard({
    super.key,
    required this.baby,
    this.isActive = true,
    this.belowTitle,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return recordsAsync.when(
      ...
      data: (records) {
        ...
        final percentileStatus = _weightPercentileStatusParts(
          l10n: l10n,
          baby: baby,
          records: visible,
        );
        final dailyTrendGPerDay = dailyWeightTrendLinearRegressionGramsPerDay(
          visible,
        );
        return Material(
          color: AppTheme.cardBackground,
                ...
                Wrap(
                  ...
                  children: [
                    _ChartFilterPill<WeightPercentile>(
                      ...
                      onChanged: (p) => ref
                          .read(weightChartPrefsProvider.notifier)
                          .setPercentile(p),
                    ),
                  ...
                  child: chartRecords.isEmpty
                      ...
                      ? Center(
                          child: Padding(
                            ...
                            child: Text(
                              l10n.weightChartNeedsMoreRecords(
          ...
          touchTooltipData: LineTouchTooltipData(
            ...
            getTooltipItems: (List<LineBarSpot> touchedSpots) {
              ...
              if (dataKg != null) {
                ...
                if (estimate != null) {
                  lines.add(
                    l10n.weightTooltipBabyPercentile(estimate.shortLabel()),
                  );
                }
              }
